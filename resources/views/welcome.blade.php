            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-7">
                    <div class="header-right-text-aria">
                        <h1>Reach the right consumer, with the right need, at the right time!</h1>
                            ...
                            <tr>
                                ...
                                <th class="table-pricing-header">
                                    <div class="text-container">
                                        ...
                                        <p class="price-text">৳3,871 BDT<sub>/month</sub></p>       
                                    </div>     
                                </th>
                                <th class="table-pricing-header">
                                    <div class="text-container">
                                        <h3 class="txt-l">Normal</h3> 
                                        <p class="price-text">৳7,757 BDT<sub>/month</sub></p>      
                                    </div>     
                                </th>
                                <th class="table-pricing-header">
                                    <div class="text-container">
                                        <h3 class="txt-l">Large</h3> 
                                        <p class="price-text">৳15,530 BDT<sub>/month</sub></p>      
                                    </div>     
                                </th>
                        ...
                        <tbody>
                            <tr class="table-pricing-row">
                                ...
                                <td class="table-pricing-details"> 
                                    ...
                                    <p class="bottom-paragraph">/ ৳3,871 BDT<sub>/month</sub></p>
                                </td>
                            </tr>
